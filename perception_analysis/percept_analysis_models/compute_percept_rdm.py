...
from perception_analysis.data_file_paths import PERCEPT_DATASET_PATH, RDM_OUTPUT_DIR


def is_model_name(col_name):
    return "vox" in col_name or "cn" in col_name or "resnet" in col_name or "ecapa" in col_name
